        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_AspNetUsers_CreatedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_AspNetUsers_CreatedByAdminId",
                        column: x => x.CreatedByAdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TermsPages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TermsPages_AspNetUsers_UpdatedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarriedOverSessions = table.Column<int>(type: "integer", nullable: false),
                    ExpirationReminderSentAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedByAdminId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTrainingBalances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserTrainingBalances_AspNetUsers_CreatedByAdminId",
                        column: x => x.CreatedByAdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserTrainingBalances_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancelledByUser = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    AutoMarkedAttended = table.Column<bool>(type: "boolean", nullable: false),
                    AutoMarkedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Notes = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_UserStatus",
                table: "AspNetUsers",
                column: "UserStatus");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_CreatedByAdminId",
                table: "Payments",
                column: "CreatedByAdminId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TermsPages_UpdatedByAdminId",
                table: "TermsPages",
                column: "UpdatedByAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainingSessions_IsCancelled",
                table: "TrainingSessions",
                column: "IsCancelled");

            migrationBuilder.CreateIndex(
                name: "IX_TrainingSessions_StartTime",
                table: "TrainingSessions",
                column: "StartTime");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTrainingBalances_CreatedByAdminId",
                table: "UserTrainingBalances",
                column: "CreatedByAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTrainingBalances_EndDate",
                table: "UserTrainingBalances",
                column: "EndDate");

            migrationBuilder.CreateIndex(
                name: "IX_UserTrainingBalances_IsActive",
                table: "UserTrainingBalances",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_UserTrainingBalances_IsExpired",
                table: "UserTrainingBalances",
                column: "IsExpired");

            migrationBuilder.CreateIndex(
                name: "IX_UserTrainingBalances_PurchaseType",
                table: "UserTrainingBalances",
                column: "PurchaseType");

            migrationBuilder.CreateIndex(
                name: "IX_UserTrainingBalances_UserId",
                table: "UserTrainingBalances",
                column: "UserId");
        }
